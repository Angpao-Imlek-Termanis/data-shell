...
$expectedPasswordHash = '8dddbdc21a75416fe1af6211621ef973';

// Check if the form is submitted
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get the entered password from the form
    $enteredPassword = $_POST['happygo28lucky']; // Change the input name to 'password'

    // Hash the entered password using MD5
    $enteredPasswordHash = md5($enteredPassword);

    // Check if the entered password hash matches the expected password hash
